...
const OrderItemsSection: React.FC<OrderItemsSectionProps> = ({
  ...
  }, [selectedCategory, index, setValue, watch, isInitialLoad, resetInventoriesAndProperties])
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ProductSelector
                      ...
                      setProductId={(value) => {
                        setValue(`items.${index}.product_id`, Number(value), { shouldDirty: true, shouldTouch: true });
                      }}
                      setVariationId={(value) =>
                        setValue(`items.${index}.product_variation_id`, value, { shouldDirty: true, shouldTouch: true })
                      }
                      options={products || []}
                      label="Product"
